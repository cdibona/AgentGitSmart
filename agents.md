...
<!-- commit: 40705bd0ab70fd25cc8f75a18501bfbccf5f5007 | generated_at: 2026-08-11T16:54:54.184969+00:00 -->
<!-- manifest_entries: 102 | symbol_count: 1349 | ctags_available: True -->
...
> `40705bd0ab70fd25cc8f75a18501bfbccf5f5007`.  It is served at `<AGENTGITSMART_SERVICE_URL>/cache/40705bd0ab70fd25cc8f75a18501bfbccf5f5007/agents.md`
...
```bash
# ── 0.  Pin the commit ────────────────────────────────────────────────
COMMIT=40705bd0ab70fd25cc8f75a18501bfbccf5f5007
...
curl -s "<AGENTGITSMART_SERVICE_URL>/cache/40705bd0ab70fd25cc8f75a18501bfbccf5f5007/symbol/TokenRefresher" | jq .
...
| Field | Value |
|-------|-------|
| `source_commit` | `40705bd0ab70fd25cc8f75a18501bfbccf5f5007` |
| `generated_at` | `2026-08-11T16:54:54.184969+00:00` |
| `manifest_entries` | 102 |
| `symbol_count` | 1349 |
