...
<!-- commit: 628748429c4abdff5c8e25ac6788a2284d9794a9 | generated_at: 2026-09-04T02:36:31.576910+00:00 -->
<!-- manifest_entries: 111 | symbol_count: 1368 | ctags_available: True -->
...
> `628748429c4abdff5c8e25ac6788a2284d9794a9`.  It is served at `<AGENTGITSMART_SERVICE_URL>/cache/628748429c4abdff5c8e25ac6788a2284d9794a9/agents.md`
...
```bash
# ── 0.  Pin the commit ────────────────────────────────────────────────
COMMIT=628748429c4abdff5c8e25ac6788a2284d9794a9
...
curl -s "<AGENTGITSMART_SERVICE_URL>/cache/628748429c4abdff5c8e25ac6788a2284d9794a9/symbol/TokenRefresher" | jq .
...
| Field | Value |
|-------|-------|
| `source_commit` | `628748429c4abdff5c8e25ac6788a2284d9794a9` |
| `generated_at` | `2026-09-04T02:36:31.576910+00:00` |
| `manifest_entries` | 111 |
| `symbol_count` | 1368 |
